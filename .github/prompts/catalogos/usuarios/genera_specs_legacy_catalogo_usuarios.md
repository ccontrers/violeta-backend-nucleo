Genera un documento en formato Markdown con el nombre y path:
	.\docs\spec-legacy-catalogo-usuarios.md
	
El objetivo es describir con el máximo detalle técnico posible la implementación actual del módulo de catálogos de usuarios en el sistema legado, de forma que un programador pueda entender exactamente cómo funciona el código existente y reprogramarlo fielmente en otra tecnología. 
...
0. Explora el código fuente de la interfaz legada en los archivos:
	- FormCatalogoUsuarios.cpp
	- FormCatalogoUsuarios.h
	- FormCatalogoUsuarios.dfm
	  Para identificar:
...
1. Analiza las funciónes backend ServidorCatalogos::ConsultaUsuario, ServidorCatalogos::GrabaUsuarios y ServidorCatalogos::BajaUsuario para documentar:
...
2. Utiliza como contexto adicional:
	...
	- Las definiciones de tablas en .\db\*.sql, considerando que:
		- La tabla central es usuarios.sql
...
- Descripción del propósito del módulo de catálogo de usuarios dentro del sistema.
...
3. Lógica de negocios de cada función (ServidorCatalogos::ConsultaUsuario, ServidorCatalogos::GrabaUsuarios y ServidorCatalogos::BajaUsuario)
