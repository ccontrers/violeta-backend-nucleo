...
Genera un documento en formato Markdown con el nombre y path:
	.\docs\spec-legacy-busqueda-proveedores.md
	
El objetivo es describir con el máximo detalle técnico posible la implementación actual del módulo de búsqueda de proveedores en el sistema legado, de forma que un programador pueda entender exactamente cómo funciona el código existente y reprogramarlo fielmente en otra tecnología.
...
1. Analiza la función backend ServidorBusquedas::BuscaProveedores para documentar:
...
- Diagrama o flujo de ejecución entre cliente (formulario) y servidor (ServidorBusquedas).
...
4. Lógica de búsqueda (ServidorBusquedas::BuscaProveedores)
