...
CREATE TABLE `articulos` (
  ...
  `idclaveunidadcfdi` int(11) NOT NULL DEFAULT 1,
  PRIMARY KEY (`articulo`),
  UNIQUE KEY `candidato` (`producto`,`present`,`multiplo`),
  UNIQUE KEY `ean13` (`ean13`) USING BTREE,
  KEY `articulos_ibfk_3` (`idclaveunidadcfdi`),
  KEY `articulos_ibfk_4` (`usualta`),
  KEY `articulos_ibfk_5` (`usumodi`),
  CONSTRAINT `articulos_ibfk_2` FOREIGN KEY (`producto`, `present`) REFERENCES `presentaciones` (`producto`, `present`) ON UPDATE CASCADE,
  CONSTRAINT `articulos_ibfk_3` FOREIGN KEY (`idclaveunidadcfdi`) REFERENCES `cclaveunidad` (`idclaveunidad`) ON UPDATE CASCADE,
  CONSTRAINT `articulos_ibfk_4` FOREIGN KEY (`usualta`) REFERENCES `usuarios` (`empleado`) ON UPDATE CASCADE,
  CONSTRAINT `articulos_ibfk_5` FOREIGN KEY (`usumodi`) REFERENCES `usuarios` (`empleado`) ON UPDATE CASCADE
