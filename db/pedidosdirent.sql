...
DROP TABLE IF EXISTS `pedidosdirent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pedidosdirent` (
  `id_pedirent` int(255) unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_pedirent`),
  KEY `referencia` (`referencia`),
  KEY `pedidoscolonia_ibfk_2` (`colonia`),
  CONSTRAINT `pedidoscolonia_ibfk_2` FOREIGN KEY (`colonia`) REFERENCES `colonias` (`colonia`) ON UPDATE CASCADE,
  CONSTRAINT `pedidosdirent_ibfk_1` FOREIGN KEY (`referencia`) REFERENCES `pedidosventa` (`referencia`) ON UPDATE CASCADE
