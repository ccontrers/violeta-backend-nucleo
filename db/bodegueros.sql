...
CREATE TABLE `bodegueros` (
  ...
  KEY `almacen` (`almacen`),
  CONSTRAINT `bodegueros_ibfk_1` FOREIGN KEY (`empleado`) REFERENCES `empleados` (`empleado`) ON UPDATE CASCADE,
  CONSTRAINT `bodegueros_ibfk_2` FOREIGN KEY (`almacen`) REFERENCES `almacenes` (`almacen`) ON UPDATE CASCADE
