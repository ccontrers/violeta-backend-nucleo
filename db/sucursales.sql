...
CREATE TABLE `sucursales` (
  ...
  `diasdistribucion` smallint(5) unsigned NOT NULL DEFAULT 7,
  PRIMARY KEY (`sucursal`),
  UNIQUE KEY `numid` (`numid`),
  KEY `nombre` (`nombre`),
  KEY `sucursalempresa_ibfk_1` (`idempresa`),
  CONSTRAINT `sucursalempresa_ibfk_1` FOREIGN KEY (`idempresa`) REFERENCES `empresas` (`idempresa`) ON UPDATE CASCADE
