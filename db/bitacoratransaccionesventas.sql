...
DROP TABLE IF EXISTS `bitacoratransaccionesventas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bitacoratransaccionesventas` (
  ...
  `trn_id` bigint(20) NOT NULL DEFAULT 0,
  ...
  `trn_relacionada` varchar(50) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `sucursal_bitacoratransaccionesventas_fk2` (`sucursal`),
  KEY `terminal_bitacoratransaccionesventas_fk1` (`terminal`),
  KEY `usu_trn_bitacoratransaccionesventas_fk3` (`usu_trn`),
  CONSTRAINT `sucursal_bitacoratransaccionesventas_fk2` FOREIGN KEY (`sucursal`) REFERENCES `sucursales` (`sucursal`) ON UPDATE CASCADE,
  CONSTRAINT `terminal_bitacoratransaccionesventas_fk1` FOREIGN KEY (`terminal`) REFERENCES `terminales` (`terminal`) ON UPDATE CASCADE,
  CONSTRAINT `usu_trn_bitacoratransaccionesventas_fk3` FOREIGN KEY (`usu_trn`) REFERENCES `empleados` (`empleado`) ON UPDATE CASCADE
