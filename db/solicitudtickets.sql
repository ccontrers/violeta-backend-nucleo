...
DROP TABLE IF EXISTS `solicitudtickets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `solicitudtickets` (
  ...
  `usucancela` varchar(10) DEFAULT NULL,
  `fechacancela` date DEFAULT NULL,
  `horacancela` time DEFAULT NULL,
  ...
  KEY `solicitudtickets_ibfk_5` (`usumodi`),
  KEY `solicitudtickets_ibfk_7` (`idJefatura`),
  CONSTRAINT `solicitudtickets_ibfk_1` FOREIGN KEY (`ususolicita`) REFERENCES `empleados` (`empleado`) ON UPDATE CASCADE,
  CONSTRAINT `solicitudtickets_ibfk_2` FOREIGN KEY (`usuvalida`) REFERENCES `empleados` (`empleado`) ON UPDATE CASCADE,
  CONSTRAINT `solicitudtickets_ibfk_3` FOREIGN KEY (`terminal`) REFERENCES `terminales` (`terminal`) ON UPDATE CASCADE,
  CONSTRAINT `solicitudtickets_ibfk_4` FOREIGN KEY (`responsable`) REFERENCES `empleados` (`empleado`) ON UPDATE CASCADE,
  CONSTRAINT `solicitudtickets_ibfk_5` FOREIGN KEY (`usumodi`) REFERENCES `empleados` (`empleado`) ON UPDATE CASCADE,
  CONSTRAINT `solicitudtickets_ibfk_6` FOREIGN KEY (`departamento`) REFERENCES `departamentossoporte` (`departamento`) ON UPDATE CASCADE,
  CONSTRAINT `solicitudtickets_ibfk_7` FOREIGN KEY (`idJefatura`) REFERENCES `catalogojefaturasordenestrabajo` (`clave`) ON UPDATE CASCADE
