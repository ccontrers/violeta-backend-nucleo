...
CREATE TABLE `dcompras` (
  ...
  CONSTRAINT `dcompras_ibfk_1` FOREIGN KEY (`referencia`) REFERENCES `compras` (`referencia`) ON UPDATE CASCADE,
  CONSTRAINT `dcompras_ibfk_2` FOREIGN KEY (`articulo`) REFERENCES `articulos` (`articulo`) ON UPDATE CASCADE
