...
CREATE TABLE `almacenes` (
  ...
  CONSTRAINT `almacenes_ibfk_1` FOREIGN KEY (`seccion`) REFERENCES `secciones` (`seccion`) ON UPDATE CASCADE,
  CONSTRAINT `almacenes_ibfk_2` FOREIGN KEY (`encargado`) REFERENCES `empleados` (`empleado`) ON UPDATE CASCADE
