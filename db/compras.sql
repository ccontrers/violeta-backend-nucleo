...
CREATE TABLE `compras` (
  ...
  `fechacom` date NOT NULL DEFAULT '0000-00-00',
  `descuento` decimal(6,5) DEFAULT NULL,
  ...
  KEY `compras_ibfk_9` (`impuestoret`),
  CONSTRAINT `compras_ibfk_1` FOREIGN KEY (`proveedor`) REFERENCES `proveedores` (`proveedor`) ON UPDATE CASCADE,
  CONSTRAINT `compras_ibfk_2` FOREIGN KEY (`almacen`) REFERENCES `almacenes` (`almacen`) ON UPDATE CASCADE,
  CONSTRAINT `compras_ibfk_3` FOREIGN KEY (`comprador`) REFERENCES `compradores` (`empleado`) ON UPDATE CASCADE,
  CONSTRAINT `compras_ibfk_4` FOREIGN KEY (`usualta`) REFERENCES `usuarios` (`empleado`) ON UPDATE CASCADE,
  CONSTRAINT `compras_ibfk_5` FOREIGN KEY (`usumodi`) REFERENCES `usuarios` (`empleado`) ON UPDATE CASCADE,
  CONSTRAINT `compras_ibfk_6` FOREIGN KEY (`docdepart`) REFERENCES `departamentos` (`depart`) ON UPDATE CASCADE,
  CONSTRAINT `compras_ibfk_7` FOREIGN KEY (`terminal`) REFERENCES `terminales` (`terminal`) ON UPDATE CASCADE,
  CONSTRAINT `compras_ibfk_8` FOREIGN KEY (`docseccion`) REFERENCES `secciones` (`seccion`) ON UPDATE CASCADE,
  CONSTRAINT `compras_ibfk_9` FOREIGN KEY (`impuestoret`) REFERENCES `impuestos` (`impuesto`) ON UPDATE CASCADE
