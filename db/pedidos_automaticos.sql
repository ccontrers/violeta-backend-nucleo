...
CREATE TABLE `pedidos_automaticos` (
  ...
  `idconcentrado` int(11) DEFAULT NULL,
  ...
  `tipo_conc` varchar(8) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `pedpre_ibfk_1` (`proveedor`) USING BTREE,
  KEY `pedpre_ibfk_2` (`almacen`) USING BTREE,
  CONSTRAINT `pedpre_ibfk_1` FOREIGN KEY (`proveedor`) REFERENCES `proveedores` (`proveedor`) ON UPDATE CASCADE,
  CONSTRAINT `pedpre_ibfk_2` FOREIGN KEY (`almacen`) REFERENCES `almacenes` (`almacen`) ON UPDATE CASCADE
