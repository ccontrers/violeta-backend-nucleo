...
DROP TABLE IF EXISTS `bitacorarecepmovproductos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bitacorarecepmovproductos` (
  `recepcion` varchar(11) NOT NULL DEFAULT '',
  ...
  `tipo` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0 - ESCANER, 1 MANUAL',
  KEY `recepcion` (`recepcion`),
  KEY `producto` (`producto`),
  KEY `present` (`present`),
  KEY `multiplo` (`multiplo`)
