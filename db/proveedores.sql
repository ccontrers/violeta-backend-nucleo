...
CREATE TABLE `proveedores` (
  ...
  KEY `replegal` (`replegal`),
  KEY `razonsocial` (`razonsocial`),
  KEY `rfc` (`rfc`),
  KEY `proveedores_ibfk_1` (`estado`),
  KEY `proveedores_ibfk_3` (`cvecolonia`),
  KEY `proveedores_ibfk_4` (`impuestoret`),
  KEY `proveedores_ibfk_usumodi` (`usumodi`),
  KEY `proveedores_ibfk_usualta` (`usualta`),
  KEY `proveedores_ibfk_capturista` (`capturista`) USING BTREE,
  KEY `proveedores_ibfk_2` (`comprador`),
  CONSTRAINT `proveedores_ibfk_1` FOREIGN KEY (`estado`) REFERENCES `estados` (`estado`) ON UPDATE CASCADE,
  CONSTRAINT `proveedores_ibfk_2` FOREIGN KEY (`comprador`) REFERENCES `compradores` (`empleado`) ON UPDATE CASCADE,
  CONSTRAINT `proveedores_ibfk_3` FOREIGN KEY (`cvecolonia`) REFERENCES `colonias` (`colonia`) ON UPDATE CASCADE,
  CONSTRAINT `proveedores_ibfk_4` FOREIGN KEY (`impuestoret`) REFERENCES `impuestos` (`impuesto`) ON UPDATE CASCADE,
  CONSTRAINT `proveedores_ibfk_capturista` FOREIGN KEY (`capturista`) REFERENCES `usuarios` (`empleado`) ON UPDATE CASCADE,
  CONSTRAINT `proveedores_ibfk_usualta` FOREIGN KEY (`usualta`) REFERENCES `usuarios` (`empleado`) ON UPDATE CASCADE,
  CONSTRAINT `proveedores_ibfk_usumodi` FOREIGN KEY (`usumodi`) REFERENCES `usuarios` (`empleado`) ON UPDATE CASCADE,
  CONSTRAINT `caja_peso_dinero` CHECK (`mincajas` = 0 and `minpeso` = 0 and `mindinero` = 0 or `mincajas` > 0 and `minpeso` = 0 and `mindinero` = 0 or `mincajas` = 0 and `minpeso` > 0 and `mindinero` = 0 or `mincajas` = 0 and `minpeso` = 0 and `mindinero` > 0)
