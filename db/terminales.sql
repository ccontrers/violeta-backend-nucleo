...
CREATE TABLE `terminales` (
  ...
  KEY `depart` (`depart`),
  KEY `seccion` (`seccion`),
  KEY `almadefa` (`almadefa`),
  KEY `destimprvta` (`destimprvta`),
  KEY `destimprncred` (`destimprncred`),
  KEY `destimprncar` (`destimprncar`),
  CONSTRAINT `terminales_ibfk_1` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`empleado`) ON UPDATE CASCADE,
  CONSTRAINT `terminales_ibfk_2` FOREIGN KEY (`depart`) REFERENCES `departamentos` (`depart`) ON UPDATE CASCADE,
  CONSTRAINT `terminales_ibfk_3` FOREIGN KEY (`seccion`) REFERENCES `secciones` (`seccion`) ON UPDATE CASCADE,
  CONSTRAINT `terminales_ibfk_4` FOREIGN KEY (`almadefa`) REFERENCES `almacenes` (`almacen`) ON UPDATE CASCADE
