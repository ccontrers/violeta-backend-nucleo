...
DROP TABLE IF EXISTS `tiposdeprecios`;
...
CREATE TABLE `tiposdeprecios` (
  ...
  PRIMARY KEY (`tipoprec`),
  KEY `descripcion` (`descripcion`),
  KEY `tiposdepreciosemp_ibfk_1` (`idempresa`),
  CONSTRAINT `tiposdepreciosemp_ibfk_1` FOREIGN KEY (`idempresa`) REFERENCES `empresas` (`idempresa`) ON UPDATE CASCADE
