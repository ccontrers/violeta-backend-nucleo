...
DROP TABLE IF EXISTS `cfdicompras`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cfdicompras` (
  `idcfdicompras` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `emitecpago` tinyint(1) DEFAULT NULL,
  `xml` mediumtext NOT NULL,
  `pdf` mediumtext NOT NULL,
  PRIMARY KEY (`idcfdicompras`),
  UNIQUE KEY `referencia` (`referencia`),
  KEY `fechacomprobante` (`fechacomprobante`),
  KEY `fechatimbrado` (`fechatimbrado`),
  CONSTRAINT `fk_cfdicompras_compras` FOREIGN KEY (`referencia`) REFERENCES `compras` (`referencia`) ON UPDATE CASCADE
