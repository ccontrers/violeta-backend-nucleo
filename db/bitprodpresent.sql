...
DROP TABLE IF EXISTS `bitprodpresent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bitprodpresent` (
  ...
  `fecha_apli` datetime NOT NULL DEFAULT current_timestamp(),
  ...
  KEY `ind_bpp_articulo` (`articulo`) USING BTREE,
  KEY `ind_bpp_prod_origen` (`prod_origen`) USING BTREE,
  KEY `ind_bpp_prod_destino` (`prod_destino`) USING BTREE,
  KEY `ind_bpp_present_origen` (`present_origen`) USING BTREE,
