...
CREATE TABLE `ventasxmes` (
  ...
  CONSTRAINT `ventasxmes2_pres` FOREIGN KEY (`producto`, `present`) REFERENCES `presentaciones` (`producto`, `present`) ON UPDATE CASCADE,
  CONSTRAINT `ventasxmes_ibfk_3` FOREIGN KEY (`almacen`) REFERENCES `almacenes` (`almacen`) ON UPDATE CASCADE
