...
class CatalogoUsuariosControllerWebTest {
    ...
    class ActualizarUsuario {
        ...
        void actualizarOk() throws Exception {
            when(service.actualizarUsuario(anyString(), any(UsuarioRequest.class))).thenReturn(successResponse);
    ...
    class EmpleadosDisponibles {
        ...
        void empleadosOk() throws Exception {
            List<EmpleadoOptionResponse> options = List.of(
                    EmpleadoOptionResponse.builder().empleado("EMP1").nombreCompleto("Nombre 1").tieneUsuario(false).build());
